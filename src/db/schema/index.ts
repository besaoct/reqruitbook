...
export const offers = pgTable("offers", {
  ...
  payFrequency: varchar("pay_frequency", { length: 32 }).default("annual").notNull(),
  signOnBonus: integer("sign_on_bonus"),
  annualBonus: text("annual_bonus"),
  ...
  templateType: varchar("template_type", { length: 64 }).default("standard").notNull(),
